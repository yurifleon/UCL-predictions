...
SPANISH_TRANSLATIONS = {
    ...
    "Please set an email and password to continue.": (
        "Configura un correo y una contraseña para continuar."
    ),
    ...
    "Maximum 12 users reached. Registration is closed.": (
        "Se alcanzó el máximo de 12 usuarios. El registro está cerrado."
    ),
    ...
    "If that email is registered, a reset link has been sent.": (
        "Si ese correo está registrado, se envió un enlace para restablecer la contraseña."
    ),
    ...
    "Admin login required.": "Se requiere iniciar sesión como admin.",
    ...
    "Admin created account for {username}.": "El admin creó la cuenta para {username}.",
    "User not found.": "Usuario no encontrado.",
    "Match deleted.": "Partido eliminado.",
    "UCL Forecast - Sign In": "UCL Forecast - Iniciar sesión",
    "UCL Round of 16 Forecast": "Pronóstico UCL de Octavos de Final",
    ...
    "Your account predates passwords. Please set an email and password to continue.": (
        "Tu cuenta es anterior al sistema de contraseñas. Configura correo y contraseña para continuar."
    ),
    ...
    "UCL Forecast - Set New Password": "UCL Forecast - Nueva contraseña",
    ...
    "No matches configured yet. Ask the admin to set them up.": (
        "Aún no hay partidos configurados. Pide al admin que los cree."
    ),
    "Locked": "Cerrado",
    "Predict": "Pronosticar",
    ...
    "Leg 1:": "Ida:",
    "Leg 2:": "Vuelta:",
    "No prediction yet.": "Aún no hay pronóstico.",
    "Make one": "Haz uno",
    ...
    "Save Prediction": "Guardar pronóstico",
    ...
    "Max per tie:": "Máximo por eliminatoria:",
    ...
    "No users registered yet.": "Aún no hay usuarios registrados.",
    "Create User (Admin)": "Crear usuario (admin)",
    "Create a user with initial login password": "Crear un usuario con contraseña inicial",
    "Temporary Password": "Contraseña temporal",
    "Set initial password": "Define una contraseña inicial",
    ...
    "No matches yet. Add one above.": "Aún no hay partidos. Agrega uno arriba.",
    "English": "Inglés",
    "Spanish": "Español",
    "Language": "Idioma",
    "UCL Forecast - Password Reset": "UCL Forecast - Restablecer contraseña",
    "Hello,\n\nClick the link below to reset your UCL Forecast password:\n\n{reset_url}\n\nThis link expires in 1 hour. If you did not request a reset, ignore this email.": (
        "Hola,\n\nHaz clic en el siguiente enlace para restablecer tu contraseña de UCL Forecast:\n\n{reset_url}\n\n"
